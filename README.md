...
На этот раз показатели выглядят намного лучше, но тем не менее видно, что retention убывает очень быстро и череp месяц платформой пользуются менее 16% пользователей. Необходимо опросить пользователей и разработать план повышения retention.

## Итоги
Все поставленные задачи выполнены. Собранные данные позволяют разработать несколько вариантов подписок. Как минимум, одна краткосрочная подписка (кто хочет здесь и сейчас порешать задачки), одна - долгосрочная (кто в целом постоянно занимается саморазвитием), некоторые части базового функционала можно урезать и делать платными. В платную подписку должны входить дополнительные фичи, например, топовые задачи от компаний, дополнительные разделы сайта (например, кейсы или вопросы). Дальше необходимо эти варианты тестировать и следить за изменениям метрик.
